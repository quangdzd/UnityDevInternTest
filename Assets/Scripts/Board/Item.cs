...
public class Item
{
    private Vector2Int indexOrigin;
    public Vector2Int IndexOrigin => indexOrigin;
    public Cell Cell { get; private set; }

    public Transform View { get; private set; }

    public virtual void SetIndexOrigin(Vector2Int vector2Int)
    {
        indexOrigin = vector2Int;
    }
    ...
    internal virtual void ExplodeView()
    {
        if (View)
        {
            ...
            seq.Join(View.DOMoveY(View.position.y + 1f, 0.3f).SetEase(Ease.OutQuad));

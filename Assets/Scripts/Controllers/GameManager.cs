...
public class GameManager : MonoBehaviour
{
    ...
    [HideInInspector]public eLevelMode Mode ;
    ...
    public void LoadLevel(eLevelMode mode)
    {
        ...
        else if(mode == eLevelMode.SELECTIONS || mode == eLevelMode.AUTO_WIN || mode == eLevelMode.AUTO_LOSE)
        {
            m_levelCondition = this.gameObject.AddComponent<LevelSelect>();
